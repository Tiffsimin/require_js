define(function(require) {
  ...
  console.log('admin province management module loaded: ');
  ...
  function createTable() {
    var ajaxUrl = jsRoutes.controllers.AdminController.getProvinces().url;
  ...
  function onModalSaveClick(data) {
    console.log('onModalSaveClick: ' + JSON.stringify(data, null, 2));
  
    adminLocationService.updateProvinceTranslation(data.id, data, function(result) {
      reloadTable();
      modal.hide();
    }, function(result) {
