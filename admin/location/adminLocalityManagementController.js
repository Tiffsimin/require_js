define(function(require) {
  ...
  console.log('admin locality management module loaded: ');
  ...
  function createTable() {
    var ajaxUrl = jsRoutes.controllers.AdminController.getLocalities().url;
  ...
  function onModalSaveClick(data) {
    adminLocationService.updateLocalityTranslation(data.id, data, function(result) {
      reloadTable();
      modal.hide();
    }, function(result) {
